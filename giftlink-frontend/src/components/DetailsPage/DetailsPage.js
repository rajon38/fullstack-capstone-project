...
function DetailsPage() {
    ...
    useEffect(() => {
        ...
        if (!authenticationToken) {
            // Task 1: Check for authentication and redirect to login if not authenticated
            navigate('/app/login');
        }
    ...
    const handleBackClick = () => {
        // Task 4: Handle back click, navigate to the previous page
        navigate(-1);
    };

    // The comments are hardcoded for this project.
    const comments = [
        {
            author: "John Doe",
        ...
        <div className="container mt-5">
            ...
            <div className="card product-details-card">
                ...
                <div className="card-body">
                    ...
                    <p><strong>Date Added:</strong> {new Date(gift.createdDate).toLocaleDateString()}</p>
